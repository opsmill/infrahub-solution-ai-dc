...
Now that you understand the data model, the [Generator Chain](/docs/ai-datacenter/generators) section explains how generators use these schemas to create infrastructure automatically.

:::tip
Keep this schema reference handy. The [Cabling Indexes](/docs/ai-datacenter/cabling-indexes) and [Architecture Takeaways](/docs/ai-datacenter/architecture-takeaways) sections reference these structure definitions.
:::
