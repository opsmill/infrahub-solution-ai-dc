...
- **[Schema Deep-Dive](./schema)**: Understand the data model
- **[Generator Chain](./generators)**: How each generator works
- **[Cabling Indexes](./cabling-indexes)**: The algorithm for deterministic cabling
- **[Design-Driven Approach](./design-driven)**: Why this matters for your business

:::info
Comfortable with what you see? Jump straight to [Architecture Takeaways](./architecture-takeaways) to learn how to extend this for your use case.
:::
