...
1. `inv publish-upstream` — mirrors every local branch into the gitignored bare repo `.upstream.git/`, then force-pushes the current checkout over the mirror's `main`
