...
![Modular Generator execution flow](./modular-generator-flow.svg)
...
![Deterministic interface allocation](./interface-allocation.svg)
...
- [EVPN/VXLAN overlay](./evpn-vxlan-overlay) — how the OverlayGenerator layers tenant services on the fabric
