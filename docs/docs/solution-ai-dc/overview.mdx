...
The demo data includes five complete, single-vendor fabrics:
...
- **Startup configuration** — six per-vendor Jinja2 templates (Cisco, Arista, Dell, Juniper, and two for SONiC — config CLI + FRR), each producing a text/plain artifact for the devices in its vendor group
...
- Five complete single-vendor fabrics (Cisco, Arista, Dell, Juniper, SONiC) with pods, racks, device templates, and IP pools
