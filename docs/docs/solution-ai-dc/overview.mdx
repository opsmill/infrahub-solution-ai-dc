...
- **Startup configuration** — five per-vendor Jinja2 templates (Cisco, Arista, Dell, Juniper, SONiC), each producing a text/plain artifact for the devices in its vendor group
