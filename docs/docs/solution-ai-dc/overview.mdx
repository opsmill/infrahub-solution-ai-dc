...
- **Startup configuration** — four per-vendor Jinja2 templates (Cisco, Arista, Dell, Juniper), each producing a text/plain artifact for the devices in its vendor group
...
- Four complete single-vendor fabrics (Cisco, Arista, Dell, Juniper) with pods, racks, device templates, and IP pools
